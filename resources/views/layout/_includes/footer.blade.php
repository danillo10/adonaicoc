	<footer>
		<div class="footer-bottom">
			<div class="container d-flex flex-row mt-3 x-outmobile">
				...
				<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 p-0">
					...
					<ul class="footer-2 p-0">
						...
						<li><i class="fas fa-home"></i>&nbsp;<a href="#">Rua São Francisco, 12 QD 13, Açailândia</a></li>
					</ul>
				</div>
			...
			<div class="container d-flex flex-column x-mobile">
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 p-0 fbb">
					<img src="{{asset('img/LOGOADONAIBRANDO2.png')}}" alt="LOGOMARCA" class="logo">
				</div>
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 mt-3 p-0 fbb">
					<h6 class="title">Adonai Coc</h6>
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 mt-3 fbb p-0">
					<h6 class="title">Últimos Tópicos</h6>
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 mt-3 fbb p-0">
					...
					<ul class="footer-2 p-0">
						...
						<li class="news"><a href="#">Agenda Digital</a></li>
						<li class="news"><a href="#"><a href="http://186.193.186.244:8088/sg_web/Acesso.aspx?escola=4242" target="_blank">Diário Eletrônico</a></a></li>
						<li class="news email"><a href="http://webmail.adonaicoc.com.br">Webmail</a></li>
					</ul>
				</div>
			</div>
		</div>

		<div class="footer-copyright x-outmobile">
			<div class="container p-0 d-flex flex-row align-items-center h-100">
				<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 pl-0 text-center">
					Copyright © 1998-2018 Instituto Educacional Adonai COC
				</div>
				<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 d-flex flex-row">
